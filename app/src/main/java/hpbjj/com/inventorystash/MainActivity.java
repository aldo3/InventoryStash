...
public class MainActivity extends AppCompatActivity
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.nav_camera) {
            this.displayView(FragmentViewType.CAMERA,id);
        } else if (id == R.id.nav_game1) {
            this.displayView(FragmentViewType.GAME1,id);
    ...
    public  enum FragmentViewType {CAMERA,GAME1};

    private void displayView(FragmentViewType fvt, int position) {
